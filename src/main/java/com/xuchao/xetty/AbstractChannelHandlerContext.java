...
public abstract class AbstractChannelHandlerContext implements ChannelHandlerContext {
    ...
    static void invokeExceptionCaught(final AbstractChannelHandlerContext next, final Throwable cause, Object in, Object out) {
        next.invokeExceptionCaught(cause, in, out);
    }

    static void invokeChannelProcess(final AbstractChannelHandlerContext next, Object in, Object out) {
